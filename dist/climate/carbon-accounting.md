...
### [CRITICAL] Misclassifying emissions leads to inaccurate inventories and double counting
...
### [HIGH] Using outdated, wrong region, or wrong fuel emission factors
...
### [HIGH] Mixing methods or using wrong approach for context
...
### [HIGH] Missing material categories or using poor screening
...
### [CRITICAL] Baseline chosen or adjusted to make targets easier
...
|---------|-------------|--------|
| `solar|wind|pv|renewable|generation` | renewable-energy | Renewable energy assessment |
| `grid|power|energy.*system|dispatch` | energy-systems | Energy systems modeling |
| `climate|scenario|temperature|projection` | climate-modeling | Climate projections |
| `supplier|procurement|supply chain` | supply-chain-analytics | Supply chain analysis |
| `ESG|report|disclosure|TCFD|CDP` | sustainability-metrics | Sustainability reporting |

### Receives Work From

- **energy-systems**: Energy consumption data for Scope 1 and 2
- **renewable-energy**: Renewable energy and avoided emissions
- **supply-chain-analytics**: Scope 3 upstream data
- **sustainability-metrics**: Broader ESG integration
...
Full skill path: `~/.spawner/skills/climate/carbon-accounting/`
