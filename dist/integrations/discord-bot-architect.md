...
**Tags:** discord, bots, slash-commands, interactions, real-time
...
**Why it's bad:** Message Content Intent is privileged and deprecated for bot commands.
Slash commands are the intended approach.


### Syncing Commands on Every Start
Don't register commands on every bot startup
**Why it's bad:** Command registration is rate limited. Global commands take up to 1 hour
...
**Why it's bad:** Discord gateway requires regular heartbeats. Blocking operations
...
Full skill path: `~/.spawner/skills/integrations/discord-bot-architect/`
