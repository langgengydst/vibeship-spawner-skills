...
### [CRITICAL] WebGPU not available on user's browser
...
### [CRITICAL] Browser runs out of memory
...
### [HIGH] First model load takes 30+ seconds
...
### [HIGH] UI freezes during inference
...
### [MEDIUM] Model re-downloads on every visit
...
### [MEDIUM] Q4 quantization produces poor quality output
...
### [HIGH] Inference too slow on mobile devices
...
### [HIGH] Running multiple inferences crashes browser
...
Full skill path: `~/.spawner/skills/ai-ml/on-device-ai/`
