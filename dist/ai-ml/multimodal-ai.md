...
### [HIGH] Images consume 10-100x more tokens than expected
...
### [MEDIUM] Audio transcription fails on unsupported formats
...
### [HIGH] Images fill context window, truncating text
...
### [MEDIUM] Vision OCR misses or hallucinates text
...
### [MEDIUM] Poor transcription from unnormalized audio
...
### [MEDIUM] Vision requests 5-10x slower than text
...
### [MEDIUM] Direct video input not supported by most APIs
...
Full skill path: `~/.spawner/skills/ai-ml/multimodal-ai/`
