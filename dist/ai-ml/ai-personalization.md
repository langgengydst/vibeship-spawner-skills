...
### [HIGH] Recommendations create echo chambers
...
### [HIGH] New users get empty or random recommendations
...
### [MEDIUM] Popular items dominate, long-tail items never shown
...
### [MEDIUM] User preferences change but embeddings don't update
...
### [HIGH] Training data biases get amplified in recommendations
...
### [CRITICAL] Recommendations reveal sensitive user information
...
### [MEDIUM] Recommendations become slow as catalog grows
...
### [HIGH] Recommendations converge to narrow set of items
...
Full skill path: `~/.spawner/skills/ai-ml/ai-personalization/`
