...
### [CRITICAL] Timestep exceeds stability limit, values grow exponentially
...
### [HIGH] Non-symplectic integrator causes secular energy error
...
### [HIGH] Discrete collision detection misses fast-moving objects
...
### [MEDIUM] Penalty forces cause oscillation at contact
...
### [MEDIUM] Floating-point precision degrades at large coordinates
...
|---------|-------------|--------|
| `digital twin|real-time|sensor data` | digital-twin | Need real-world integration |
| `Monte Carlo|uncertainty|probabilistic` | monte-carlo | Need uncertainty quantification |
| `agent|multi-agent|population` | agent-based-modeling | Need agent-based simulation |

### Receives Work From

- **digital-twin**: Physics model for digital twin
- **control-systems**: Model for control simulation
...
Full skill path: `~/.spawner/skills/simulation/physics-simulation/`
