...
> The art and science of narrative-driven brand communication. This skill
transforms brand messages into compelling stories that connect emotionally,
build memory, and drive action. In a world of infinite content, story is
the only thing that cuts through.

Great brands don't sell products—they tell stories. Apple tells the story
of creative rebels. Nike tells the story of human potential. Patagonia
tells the story of environmental stewardship. This skill teaches you to
find, craft, and tell your brand's story across every touchpoint.

AI amplifies storytelling capability—generating variations, adapting across
channels, maintaining consistency—but the human insight that identifies the
true story remains essential. This skill bridges narrative craft with AI execution.


**Category:** marketing | **Version:** 1.0.0

**Tags:** storytelling, narrative, brand-story, emotional, hero-journey, content
...
**Instead:** Brand is guide/mentor. Customer is hero.

### Feature Story
Listing features dressed up as "story"
**Instead:** Show features through transformation story.

### Conflict Avoidance
Stories without stakes or struggle
**Instead:** Embrace the problem. Show the struggle.

### Generic Journey
Vague, could-be-any-brand storytelling
**Instead:** Specificity. Details. Real names and numbers.

### Happy-Only Stories
Refusing to show challenges or failures
**Instead:** Include struggle. Show authentic challenges.

### Story Without Stakes
Narratives where nothing is at risk
**Instead:** Make clear what could be lost.
...
### [CRITICAL] Making the brand the protagonist instead of the customer

**Situation:** Creating stories where the brand saves the day, the brand is the
...
### [HIGH] Creating stories without real stakes or struggle

**Situation:** Telling stories where everything is fine, the solution is easy, and
...
### [HIGH] Vague narratives that could apply to any brand

**Situation:** Creating stories so generic they could have any brand name swapped in.
...
### [HIGH] Narratives where nothing meaningful is at risk

**Situation:** Telling stories where the outcome doesn't really matter, the hero
...
### [MEDIUM] Listing features disguised as storytelling

**Situation:** Dressing up a feature list with narrative language but without actual
...
### [MEDIUM] Refusing to show any struggle, failure, or challenge

**Situation:** Creating relentlessly positive narratives where everything is easy,
...
### [MEDIUM] Different stories that contradict each other

**Situation:** Telling different origin stories, changing the brand narrative,
...
### [MEDIUM] Describing instead of demonstrating

**Situation:** Telling the audience what to think ("We're innovative") instead of
...
### [LOW] Stories without evidence or data without narrative

**Situation:** Either telling emotional stories without proof, or presenting data
...
### [MEDIUM] Stories without clear before/after change

**Situation:** Telling narratives that don't show transformation—stories that go
...
Full skill path: `~/.spawner/skills/marketing/brand-storytelling/`
