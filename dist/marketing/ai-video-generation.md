...
**Tags:** ai-video, veo3, runway, sora, kling, pika, generation, text-to-video, neural, synthesis
...
|---------|-------------|--------|
| `generate image|seed frame|reference image|concept art` | ai-image-generation | Need starting image for image-to-video generation |
| `digital human|AI presenter|avatar|talking head|lip sync` | digital-humans | Video needs human presenter with speech |
| `upscale|enhance|4K|8K|visual effects|compositing` | ai-visual-effects | Raw generation needs enhancement |
| `music|soundtrack|audio|sound design|background music` | ai-audio-production | Video needs audio track |
| `voiceover|narration|voice|VO` | voiceover | Video needs voice narration |
| `prompt optimization|better prompts|prompt help` | prompt-engineering-creative | Need better prompts for quality output |
| `ad creative|advertisement|commercial|performance` | ai-ad-creative | Video is for advertising |
| `orchestrate|full production|multi-tool|campaign` | ai-creative-director | Complex production needs orchestration |
...
Full skill path: `~/.spawner/skills/marketing/ai-video-generation/`
