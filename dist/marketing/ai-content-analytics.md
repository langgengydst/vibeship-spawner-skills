...
**Tags:** ai-content, analytics, measurement, attribution, roi, ab-testing, performance, optimization, data-driven, content-analytics
...
### [CRITICAL] Tracking AI content outputs instead of business outcomes

**Situation:** Team celebrates: "We generated 5,000 AI blog posts this quarter!"
...
### [CRITICAL] Attribution is hard with AI+human hybrid content, so teams track nothing

**Situation:** AI generates draft → Human edits → Content published.
...
### [HIGH] Calling A/B test winners before reaching statistical significance

**Situation:** A/B testing two AI variations.
...
### [HIGH] Assuming AI content must sacrifice quality for speed

**Situation:** Team uses AI to generate 10x content volume.
...
### [HIGH] Optimizing for short-term engagement at expense of brand trust

**Situation:** AI generates clickbait headlines that spike CTR by 40%.
...
### [MEDIUM] Focusing only on immediate conversion metrics, missing compound value

**Situation:** Team kills AI blog strategy because "blogs don't convert immediately."
...
### [CRITICAL] Sending user data to AI models without proper consent or handling

**Situation:** Marketing team feeds customer emails, names, purchase history into AI to
...
### [HIGH] Not monitoring AI model quality degradation over time

**Situation:** AI content quality was great 3 months ago (8.5/10).
...
### [HIGH] Tracking total cost but not cost efficiency relative to quality/outcomes

**Situation:** Team A: "AI content costs $5 per piece, human costs $400. AI is 80x cheaper!"
...
### [MEDIUM] Comparing AI content to different conditions (time, topic, distribution)

**Situation:** Team: "Our AI blog posts get 500 views on average!"
...
|---------|-------------|--------|
| `content strategy|plan content|editorial calendar` | content-strategy | Analytics insights inform content strategy |
| `generate ai content|create with ai|ai variations` | ai-creative-director | Analytics findings guide AI content generation |
| `improve copy|optimize headlines|better cta` | copywriting | Analytics data shows what copy elements work |
| `marketing campaign|distribute content|promote` | marketing | Analytics shows which content to amplify |
| `growth optimization|conversion funnel|experimentation` | growth-strategy | Analytics reveals growth opportunities |
| `seo optimization|organic traffic|search rankings` | seo | Analytics shows organic performance of AI content |
| `content quality|qa review|brand consistency` | ai-content-qa | Analytics identifies quality issues to address |

### Receives Work From

- **content-strategy**: Content strategy defines what to create, analytics measures what works
- **ai-creative-director**: AI creative director generates content, analytics measures performance
- **marketing**: Marketing campaigns distribute content, analytics tracks results
- **copywriting**: Copywriting creates messaging, analytics validates effectiveness
- **growth-strategy**: Growth strategy sets goals, analytics measures progress
...
Full skill path: `~/.spawner/skills/marketing/ai-content-analytics/`
