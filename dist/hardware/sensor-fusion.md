...
### [CRITICAL] Incorrectly tuned noise covariances cause filter divergence or overconfidence
...
### [CRITICAL] Wrong Jacobian causes incorrect covariance and filter divergence
...
### [HIGH] Mixing NED/ENU or body/world frames corrupts fusion
...
### [HIGH] Using arrival time instead of measurement time causes lag
...
### [HIGH] Covariance becomes too small, filter ignores valid measurements
...
### [MEDIUM] Starting with wrong initial covariance causes slow convergence or divergence
...
|---------|-------------|--------|
| `control|trajectory|path following` | control-systems | Using filter output for control |
| `ROS|robot_localization|nav2` | ros2-robotics | Need ROS2 integration |
| `MCU|STM32|embedded|real-time` | embedded-systems | Need embedded implementation |
| `camera|visual|feature|VIO` | computer-vision | Need visual-inertial odometry |

### Receives Work From

- **embedded-systems**: Need sensor fusion on microcontroller
- **ros2-robotics**: Need localization for navigation
- **statistical-analysis**: Need noise characterization
...
Full skill path: `~/.spawner/skills/hardware/sensor-fusion/`
